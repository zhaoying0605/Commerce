...
<div id="father">
    ...
    <div class="hengxaing">
        <div class="LoginForm">
            ...
            >
                <el-form-item label=" " class="phone" name="phone" id="phone" prop="phone">
                    <el-input
                        placeholder="请输入用户名"
                ...
                <el-form-item label=" " class="phone" name="phone" id="phone" prop="password">
                    <el-input
                        type="password"
                        placeholder="请输入密码"
    ...
    data() {
        return {
            ...
            rules:{
                ...
                password:[
                    {required:true,message:"请先您设置的密码",trigger:"blur"},
                    {
                        max:20,
                        min:6,
                        message:"输入的密码范围不规范!",
