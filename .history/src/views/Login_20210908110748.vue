        ...
        <div class="LoginForm">
            ...
            >
                <div>
                    ...
                    <el-input v-model="input" placeholder="请输入内容" clearable style="width:330px;height:50px"></el-input>
                </div>
                ...
                <div id="msg" style="color: red;float: left;margin-left: 50px;font-size: 14px;line-height: 15px"></div>
                <br><br>
                <div>
